...
<head>
  ...
  <style>
    ...
    .am5-tooltip {
      ...
      /* Background color is handled by getFillFromSprite per series */
    }
  </style>
</head>
<body>
...
am5.ready(function() {
  ...
  const overlayColors = { "This Week": "#228B22", "Last Week": "#FFA500", "2 Weeks Ago": "#800080", "3 Weeks Ago": "#DC143C" }; // Used for line color AND tooltip background via getFillFromSprite
  ...
  // --- Primary Series Creation (Value2 Bars toggleable - Unchanged) ---
  function createPrimarySeries(chart, root, primaryData, xAxis, yAxis) {
    ...
    value2Series = chart.series.push(am5xy.ColumnSeries.new(root, {
      ...
      tooltip: am5.Tooltip.new(root, {
          getFillFromSprite: false, // Don't use column color for bg
    ...
    lineSeries = chart.series.push(am5xy.LineSeries.new(root, {
      ...
      connect: false,
      tooltip: am5.Tooltip.new(root, {
          getFillFromSprite: true, // Background matches line stroke (dark blue)
          labelTextColor: am5.color(0xffffff), fontSize: tooltipFontSize,
