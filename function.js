window.function = function (
    data, overlayDataJson, intervalName, type,
...
<head>
  ...
  <style>
    ...
    #controls {
        width: ${chartWidth}%;
        text-align: center;
        padding: 5px 0 10px 0; /* Reduced top padding */
...
am5.ready(function() {
  ...
  function createLegend(chart, root, mainLineSeries, fillSeriesToToggle, barsSeries, otherSeries) {
     ...
     var legend = chart.children.push(am5.Legend.new(root, {
         ...
         marginTop: 15, marginBottom: 15 // Keep margin below legend
     }));
     ...
     legend.data.setAll(legendSeries); // This adds all series (main, bars, overlays)
